...
\end{align*}
La lunghezza media del codice di Shannon è:
\begin{align*}
    L_S(C) & = \sum_{i=0}^2 p_i \cdot l_i = \frac{2}{3}\cdot 1 + \frac{2}{9}\cdot 3 + \frac{1}{9}\cdot 4 = \approx 1.78
\end{align*}
...
\end{align*}
come si nota facilmente il codice che verrebbe generato con la codifica di Shannon \textbf{non è un codice compatto né ottimale}. Infatti, ad esempio, è possibile costruire un codice a prefisso con lunghezza media più vicina all'entropia, ad esempio:
\begin{table}[htpb]
    \centering
    \begin{tabular}{|l|l|}
        \hline
...
con lunghezza media:
\begin{align*}
    L_S(C') & = \sum_{i=0}^2 p_i \cdot l_i = \frac{2}{3}\cdot 1 + \frac{2}{9}\cdot 2 + \frac{1}{9}\cdot 2 \approx 1.33
\end{align*}
