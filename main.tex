...
Visto che la costruzione di codici, come visto in precedenza, porta a NON avere un codice compatto o ottimale. Per questo motivo Shannon ha proposto un metodo di costruzione più diretto, che associa a ciascun simbolo $s_i$ una parola di codice basata sulla sua probabilità cumulativa. Grazie a questo metodo si cerca di costruire un codice la cui lunghezza media tende sempre di più verso il suo limite inferiore, l'entropia della sorgente.
...
\begin{theorem}
    ...
    \]
    ovvero, l'entropia della sorgente estesa $S^n$ è pari a $n$ volte l'entropia della sorgente originaria $S$. Inoltre, si definisce come lunghezza media per simbolo di un codice $C$ per la sorgente estesa $S^n$ la quantità:
    \[
...
\]
Comunque resta sempre un margine di inefficienza, rappresentato da $\frac{1}{n}$, che tende a zero ma non è mai nullo. Quindi, anche con la codifica di Shannon, non si riesce ad ottenere un codice compatto o ottimale, ma si riesce ad avvicinare arbitrariamente l'entropia della sorgente.
